      ...
      {selectedCategory && isModalVisible && (
        <div className="absolute w-3/4 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-slate-200 p-8">
          <form action="#">
            ...
            <button onClick={() => disableCat(selectedCategory.id)} className="btn bg-red-700 px-4 py-2 text-white">
              غیرفعال کردن
            </button>
            <button onClick={confirmChanges} className="btn bg-green-700 px-4 py-2 text-white mx-4">
              ثبت تغییرات
            </button>
          </form>
